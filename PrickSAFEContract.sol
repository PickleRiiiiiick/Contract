...
/**
   ...
   #picke
   2% para la pinches liquidez
   2% repartido entre la  banda
   2% para las chelas
   si juntamos  2 millones rentamos el azteca para una peda
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xCe878c8D40718Eb84D8218DCBe7b9aBeC6f3c058;
...
contract CruzAzul is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xCe878c8D40718Eb84D8218DCBe7b9aBeC6f3c058;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 19272021 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Pickle Rick";
    string private _symbol = "PickleR";
